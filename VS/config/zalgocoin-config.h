/* src/config/zalgocoin-config.h.  Generated from zalgocoin-config.h.in by configure.  */
/* src/config/zalgocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ZALGOCOIN_CONFIG_H

#define ZALGOCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Zalgocoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Zalgocoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/EnricoBotassa/zalgocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Zalgocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Zalgocoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zalgocoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://zalgocoin.org/"
