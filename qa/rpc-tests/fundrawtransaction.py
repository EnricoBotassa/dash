...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid zalgocoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid zalgocoin address" in e.error['message'])
        ...
        # send 12 ZALGOCOIN to msig addr
