...
Zalgocoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Zalgocoin Core, where everyone uses
...
pay attention to for reviewers of Zalgocoin Core code.

General Zalgocoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Zalgocoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Zalgocoin Core so that they can be integrated
