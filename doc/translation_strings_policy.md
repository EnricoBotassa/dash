...
This document provides guidelines for internationalization of the Zalgocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zalgocoin_en.ts` remains unchanged.
