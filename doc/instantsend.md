...
This mechanism has been integrated into Bitcore-Node-Zalgocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/enricobotassa/insight-api-zalgocoin#web-socket-api](https://github.com/enricobotassa/insight-api-zalgocoin#web-socket-api)
* API: [https://github.com/enricobotassa/insight-api-zalgocoin#instantsend-transactions](https://github.com/enricobotassa/insight-api-zalgocoin#instantsend-transactions)
...
By default, the Zalgocoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zalgocoin Core daemon:
