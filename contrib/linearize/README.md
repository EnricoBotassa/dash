# Linearize
Construct a linear, no-fork, best version of the Zalgocoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install zalgocoin_hash

https://github.com/EnricoBotassa/zalgocoin_hash
...
JSON-RPC server. Running `zalgocoind` or `zalgocoin-qt -server` will be sufficient.
...
* `input`: zalgocoind blocks/ directory containing blkNNNNN.dat
