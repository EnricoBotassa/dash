...
official/supported Docker Images found at https://hub.docker.com/r/enricobotassa/zalgocoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/enricobotassa/zalgocoind-develop/ when changing the above text**