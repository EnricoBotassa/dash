...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Zalgocoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "zalgocoin",               "masternode",             &masternode,             true,  {} },
    { "zalgocoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "zalgocoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "zalgocoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "zalgocoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "zalgocoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
