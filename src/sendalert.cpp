...
2. run zalgocoind with -printalert or -sendalert like this:
   /path/to/zalgocoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.zalgocoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Zalgocoin Core:0.12.0.58/"));
