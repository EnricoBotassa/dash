#ifndef ZALGOCOIN_CHAINPARAMSSEEDS_H
#define ZALGOCOIN_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the zalgocoin network
...
#endif // ZALGOCOIN_CHAINPARAMSSEEDS_H
